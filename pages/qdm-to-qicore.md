...
| negation rationale                            | [Observation.dataAbsentReason](StructureDefinition-qicore-observation-definitions.html#Observation.dataAbsentReason)                     | Initial table indicates extensible but detailed link indicates SHALL - <http://hl7.org/fhir/R4/observation-definitions.html#Observation.dataAbsentReason> |
...
#### 8.4.4 Diagnostic Study, Performed
...
#### 8.4.5 Laboratory Test, Performed
...
Other observations that meet the QDM definition of Physical Exam, Performed use the FHIR Observation resource

Note: QDM 5.5 removed the "method" attribute from "Physical Exam, Order" and "Physical Exam, Recommended"

##### 8.4.6.1 Physical Exam, Performed: General
...
|                                        | [Observation.issued](StructureDefinition-qicore-observation-definitions.html#Observation.issued)                                         | Observation.issued is the time this version of the observation was made available to providers. It does not seem appropriate for dataAbsentReason recorded dateTime. A new extension is required.                                                                                |
...
#### 8.8.4 Device, Recommended(All Except Personal-Use Devices)
...
| Reason                  | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                      |                                                                                                                                                                                                                                                                                                                |
| Author dateTime         | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                      | FHIR allows dateTime or Period for desired time or schedule for use.                                                                                                                                                                                                                                                                                                                                                                  |
| Negation Rationale      | [ServiceRequest.code.extension:notDoneValueSet](StructureDefinition-qicore-servicenotrequested-definitions.html#ServiceRequest.code.extension:notDoneValueSet) | Use the ServiceNotRequested which specifies:<ul><li>What was not performed (ServiceRequest.code.extension:notDoneValueSet)</li><li>ServiceRequest.status fixed as “not-done”</li><li>ServiceRequest.statusReason uses qicore-negation-reason value set</li><li>ServiceRequest.authoredOn as timing for documentation of the negation rationale</li></ul>|
| Requester               | [ServiceRequest.requester](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.requester)                        |                                                                                                                                                                                                                                                                                                                                                                   |
{: .grid}
...
| Negation Rationale      | [DeviceRequest.extension:doNotPerform](StructureDefinition-qicore-devicenotrequested-definitions.html#DeviceRequest.extension:doNotPerform) | Use the DeviceNotRequested profile which specifies:<br><ul><li>DeviceRequest.extension:DoNotPerform</li><li>What was not performed (DeviceNotRequested.code[x].extension:doNotPerformValueSet)</li><li>DeviceRequest.status fixed as “completed”</li><li>DeviceRequest.intent fixed as “order”</li><li>DeviceRequest.extension:doNotPerformReason uses qicore-negation-reason value set</li><li>DeviceRequest.authoredOn as timing for documentation of the negation rationale</li></ul><br>ServiceRequest includes a doNotPerform; DeviceRequest does not|
| Requester               | [DeviceRequest.requester](StructureDefinition-qicore-devicerequest-definitions.html#DeviceRequest.requester)                           |                                                                                                                                                                                                                                                                                                                                                                   |
{: .grid}

#### 8.8.6 Device, Recommended (Personal Use Device Only)
...
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **Race**                             |                                                                                                                                                                                 | See USCoreRaceExtension for details                                                                                                                |
| code                                 | [Patient.extension:race](StructureDefinition-qicore-patient-definitions.html#Patient.extension:race)                                         |                                                                                                                 |
| id                                   |                                                                                                                                                                                 |                                                                                                                 |
| **Ethnicity**                        |                                                                                                                                                                                 |                                                                                                                 |
| code                                 | [Patient.extention:ethnicity](StructureDefinition-qicore-patient-definitions.html#Patient.extension:ethnicity)                               | See USCoreEthnicityExtension for details                                                                                                                |
| id                                   |                                                                                                                                                                                 |                                                                                                                 |
| **Sex**                              |                                                                                                                                                                                 |                                                                                                                 |
...
|                                                      | [Procedure.extension:doNotPerformTiming](StructureDefinition-doNotPerformTiming.html)                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Relevant dateTime                                    | [Procedure.performed\[x\] dateTime](StructureDefinition-qicore-procedure-definitions.html#Procedure.performed[x])                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Relevant Period                                      | [Procedure.performed\[x\] Period](StructureDefinition-qicore-procedure-definitions.html#Procedure.performed[x])                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
Old MedicationRequest: Represents an authorization to dispense and administer a medication (aka prescription or order)

New MedicationRequest: An order or request for both supply of the medication and the instructions for administration of the medication to a patient, and patient reported medications.

Old MedicationStatement: Represents the record for past, present, and future medications use. Not used for accessing a patient’s medications.

New MedicationStatement: Represents the record for past, present, and future medications use. The MedicationStatement Resource is NOT used in this guide.

Therefore, Medication, Active should reference MedicationRequest and NOT MedicationStatement. The rationale is that the MedicationStatement.status allows use of 
both *active* and *not taken*. That means there is no assurance the patient is actually taking the medication. Discussion in the US Core Update reconciliation 
in Atlanta generated the change in MedicationRequest definition for US Core. The MedicationRequest.intent should always be *order* even if the medication is 
patient reported and the order is not processed as an e-prescription. The reporter is specified as MedicationRequest.reported[x] which is a reportedBoolean and 
uses reportedReference (patient, practitioner, practitionerRole, relatedPerson, organization).
...
| author dateTime               |                                                                                                                                                                                    |                                                                                                                                  |
| Negation rationale            | [MedicationDispense.status](StructureDefinition-qicore-medicationdispense-definitions.html#MedicationDispense.status)                                                              | Constrain MedicationDispense.status code to cancelled, declined.                                                                 |
...
MedicationRequest.intent should always be *order* even if the medication is patient reported and the order is not processed as an e-prescription. 
The reporter is specified as MedicationRequest.reported[x] which is a reportedBoolean and uses reportedReference (patient, practitioner, practitionerRole, relatedPerson, organization).

This change should also be used to reference the mapping from QDM Medication, Order which can address order or recommended.

Consider how to address Medication, Order given this new information. Note that recommended or order should both use MedicationRequest.intent = order.
...
#### 8.16.1 Generic Service Request

| **QDM Context**                                                   | **QI-Core R4**                                                                                                                                                                           | **Comments**                                                 |
| ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| **Service Request**                                               | [ServiceRequest](StructureDefinition-qicore-servicerequest.html)                                                                            |                                                              |
| Service Request Activity (QDM implied active, on-hold, completed) | [ServiceRequest.status](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.status)                                   | Constrain to one or more of active, on-hold, completed       |
| Recommended context                                               | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "plan"                                     |
| Order context                                                     | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                              |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       |                                                              |
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
...
| Negation Rationale                                                | [ServiceRequest.code.extension:notDoneValueSet](StructureDefinition-qicore-servicenotrequested-definitions.html#ServiceRequest.code.extension:notDoneValueSet) | Use the ServiceNotRequested which specifies:<br><ul><li>What was not performed (ServiceRequest.code.extension:notDoneValueSet)</li><li>ServiceRequest.status fixed as “completed”</li><li>ServiceRequest.doNotPerform</li><li>ServiceRequest.extension:reasonRefused uses qicore-negation-reason value set</li><li>ServiceRequest.authoredOn as timing for documentation of the negation rationale</li></ul> |
| Requester                                                         | [ServiceRequest.requester](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.requester)                             |                                                              |
{: .grid}

#### 8.16.2 Assessment, Order

For assessments except for US Core Smoking Status:
...
#### 8.16.4 Assessment, Order - To capture US Core Smoking Status
...
|                                                                   | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                                                                           |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       | Constrain codes to the value set: us-core-smoking-status-observation-codes|
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable.                                                             |
| Negation Rationale                                                | [ServiceRequest.code.extension:notDoneValueSet](StructureDefinition-qicore-servicenotrequested-definitions.html#ServiceRequest.code.extension:notDoneValueSet) | Use the ServiceNotRequested which specifies:<br><ul><li>What was not performed (ServiceRequest.code.extension:notDoneValueSet)</li><li>ServiceRequest.status fixed as “completed”</li><li>ServiceRequest.doNotPerform</li><li>ServiceRequest.extension:reasonRefused uses qicore-negation-reason value set</li><li>ServiceRequest.authoredOn as timing for documentation of the negation rationale</li></ul> |
...
#### 8.16.5 Assessment, Recommended - To capture US Core Smoking Status
...
#### 8.16.7 Diagnostic Study, Recommended
...
| Priority                                                          | [ServiceRequest.modifierExtension:isElective](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.modifierExtension:isElective)| Referencing priority for an Encounter, Order:<br><ul><li>To indicate the QDM concept of a recommendation for an elective encounter requires use of the QI-Core extension: ServiceRequest.modifierExtension:isElective. This is a boolean value.</li><li>ServiceRequest.priority uses a required RequestPriority value set (limited to only: routine, urgent, asap, stat). Therefore, to indicate these concepts, use the ServiceRequest.priority. However, feedback suggests that “routine” is not the same as “elective,” so use ServiceRequest.modifierExtension:isElective to indicate an “elective” Encounter, Order.</li></ul>|
| Negation Rationale                                                | [ServiceRequest.code.extension:notDoneValueSet](StructureDefinition-qicore-servicenotrequested-definitions.html#ServiceRequest.code.extension:notDoneValueSet) | Use the ServiceNotRequested which specifies:<br><ul><li>What was not performed (ServiceRequest.code.extension:notDoneValueSet)</li><li>ServiceRequest.status fixed as “completed”</li><li>ServiceRequest.doNotPerform</li><li>ServiceRequest.extension:reasonRefused uses qicore-negation-reason value set</li><li>ServiceRequest.authoredOn as timing for documentation of the negation rationale</li></ul> |
| Requester                                                         | [ServiceRequest.requester](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.requester)                             |                                                              |
{: .grid}

#### 8.16.9 Encounter, Recommended
...
#### 8.16.11 Intervention, Recommended
...
#### 8.16.13 Laboratory Test, Recommended
...
#### 8.16.14 Physical Exam, Order

For use with an order for a physical examination activity not otherwise 
specified (US Core Pediatric BMI for Age; US Core Pediatric Weight for 
Height, US Core Pulse Oximetry, FHIR Vital Signs). 
...
#### 8.16.15 Physical Exam, Recommended

For use with a recommendation for a physical examination activity not 
otherwise specified (US Core Pediatric BMI for Age; US Core Pediatric 
Weight for Height, US Core Pulse Oximetry, FHIR Vital Signs).
...
#### 8.16.16 Physical Exam, Order - Specifically for US Core Pediatric BMI for Age 
...
|                                                                   | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                              |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       | Constrain to Fixed Value: 59576-9                            |
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable.                                                             |
| Anatomical Location Site                                          | [ServiceRequest.bodySite](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.bodySite)                               |                                                              |
...
#### 8.16.17 Physical Exam, Recommended - Specifically for US Core Pediatric BMI for Age 
...
#### 8.16.18 Physical Exam, Order - Specifically for US Core Pediatric Weight for Height
...
|                                                                   | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                              |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       | Constrain to Fixed Value: 77606-2                            |
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable.                                                             |
| Anatomical Location Site                                          | [ServiceRequest.bodySite](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.bodySite)                               |                                                              |
...
#### 8.16.19 Physical Exam, Recommended - Specifically for US Core Pediatric Weight for Height 
...
#### 8.16.20 Physical Exam, Order - Specifically for US Core Pulse Oximetry
...
|                                                                   | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                              |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       | Constrain to Fixed Value: 3151-8                            |
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable.                                                             |
| Anatomical Location Site                                          | [ServiceRequest.bodySite](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.bodySite)                               |                                                              |
...
#### 8.16.21 Physical Exam, Recommended - Specifically for US Core Pulse Oximetry
...
#### 8.16.22 Physical Exam, Order - Specifically for FHIR Vital Signs
...
|                                                                   | [ServiceRequest.intent](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.intent)                                   | Constrain only to "order" (include children: original-order, reflex-order, filler-order, instance-order)  |
| **QDM Attributes**                                                |                                                                                                                                             |                                                              |
| Code                                                              | [ServiceRequest.code](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.code)                                       | Constrain to Fixed Values to reference the specific vital sign(s) of interest:<br><ul><li>Vital signs panel: 85353-1</li><li>Respiratory rate: 9279-1</li><li>Heart rate: 8867-4</li><li>Oxygen saturation: 2708-6</li><li>Body temperature: 8310-5</li><li>Body height: 8302-2</li><li>Head circumference: 9843-4</li><li>Body weight: 29463-7</li><li>Body mass index: 39156-5</li><li>Blood pressure systolic and diastolic: 85354-9</li><li>Systolic blood pressure: 8480-6</li><li>Diastolic blood pressure: 8462-4</li></ul>|
| id                                                                | [ServiceRequest.id](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.id)                                           |                                                              |
| Reason                                                            | [ServiceRequest.reasonCode](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.reasonCode)                           |                                                              |
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable.                                                             |
| Anatomical Location Site                                          | [ServiceRequest.bodySite](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.bodySite)                               |                                                              |
...
#### 8.16.23 Physical Exam, Recommended - Specifically for FHIR Vital Signs
...
| Anatomical Location Site                                          | [ServiceRequest.bodySite](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.bodySite)                               |                                                              |
| Priority                                                          | [ServiceRequest.modifierExtension:isElective](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.modifierExtension:isElective)| Referencing priority for an Encounter, Order:<br><ul><li>To indicate the QDM concept of a recommendation for an elective encounter requires use of the QI-Core extension: ServiceRequest.modifierExtension:isElective. This is a boolean value.</li><li>ServiceRequest.priority uses a required RequestPriority value set (limited to only: routine, urgent, asap, stat). Therefore, to indicate these concepts, use the ServiceRequest.priority. However, feedback suggests that “routine” is not the same as “elective,” so use ServiceRequest.modifierExtension:isElective to indicate an “elective” Encounter, Order.</li></ul>|
| Rank                                                              | NEED TO FIND WHAT HAPPENED TO THE NEW EXTENSION FOR PROCEDURE PRINCIPAL THAT WE TALKED ABOUT                                                |      |
| Negation Rationale                                                | [ServiceRequest.code.extension:notDoneValueSet](StructureDefinition-qicore-servicenotrequested-definitions.html#ServiceRequest.code.extension:notDoneValueSet) | Use the ServiceNotRequested which specifies:<br><ul><li>What was not performed (ServiceRequest.code.extension:notDoneValueSet)</li><li>ServiceRequest.status fixed as “completed”</li><li>ServiceRequest.doNotPerform</li><li>ServiceRequest.extension:reasonRefused uses qicore-negation-reason value set</li><li>ServiceRequest.authoredOn as timing for documentation of the negation rationale</li></ul> |
| Requester                                                         | [ServiceRequest.requester](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.requester)                             |                                                              |
{: .grid}

#### 8.16.25 Procedure, Recommended
| **QDM Context**                                                   | **QI-Core R4**                                                                                                                                                                           | **Comments**                                                 |
| ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
