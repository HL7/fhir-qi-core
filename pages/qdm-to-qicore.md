...
This QDM context correlates with a medication on a patient’s active medication list. Consistent with the US Core STU
Release 3.1.0 [Medication List Guidance](http://hl7.org/fhir/us/core/all-meds.html) active medications for a medication
list should be based on MedicationRequest. Each medication on the list should be referenced with a
MedicationRequest.status = active or on-hold (completed, cancelled, entered-in-error, stopped, draft or unknown do not
apply). Further, the MedicationRequest.intent = order for all medications on the list. To represent medications reported
by a physician, a patient or a patient's care partner, use MedicationRequest.reported\[x\] indicating practitioner,
patient or relatedPerson. For medications on the list derived directly from electronic prescriptions use
MedicationRequest.reported\[x\] = organization. Note that QDM's Medication, Active does not allow negation rationale,
i.e., a reason that a medication is not on the list. To address such concepts, the eCQM expression should address the
reason a MedicationRequest was not performed (see MedicationRequest negation rationale mapping.

| **QDM Context**            | **QI-Core R4**                                                                                                                                                                                                                                   | **Comments**                                                                                                                                                  |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Medication, Active**     | [MedicationRequest](StructureDefinition-qicore-medicationrequest.html)                                                                                                                               |                                                                                                                                                               |
| Medication, Active context | [MedicationRequest.status](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.status)                                                                                   | Constrain to "active"                                                                                                                                         |
...
|                            | [MedicationRequest.basedOn](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.basedOn)                                                                                 | A plan, proposal or order that is fulfilled in whole or in part by this event                                                                                 |
| **QDM Attribute**          |                                                                                                                                                                                                                                                  |                                                                                                                                                               |
...
| reported                   | [MedicationRequest.reported\[x\]](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.reported[x])                                                               | The MedicationRequest.reported as referenced by the US Core STU3 Release 3.1.0 allows differntiation of medications on the medication list based on the following: (a) to indicate doctor/practitioner-reported, reference practitioner, (b) to reference patient or care partner-reported, reference patient or relatedPerson, (c) to reference prescriptions written for the ambulatory setting, reference organization.                                                                                                                                                              |
...
| frequency                  | [MedicationRequest.dosageInstruction.timing](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.dosageInstruction.timing)                                               | When medication should be administered. The timing schedule for giving the medication to the patient. This data type allows many different expressions. For example: "Every 8 hours"; "Three times a day"; "1/2 an hour before breakfast for 10 days from 23-Dec 2011:"; "15 Oct 2013, 17 Oct 2013 and 1 Nov 2013". Sometimes, a rate can imply duration when expressed as total volume / duration (e.g. 500mL/2 hours implies a duration of 2 hours). However, when rate doesn't imply duration (e.g. 250mL/hour), then the timing.repeat.duration is needed to convey the infuse over time period.                                                                                                                                                              |
...
|                            | [MedicationRequest.dispenseRequest.validityPeriod](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.dispenseRequest.validityPeriod)                                                                           |                                                                                                                                                               |
| relevant dateTime          | [MedicationRequest.dispenseRequest.validityPeriod](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.dispenseRequest.validityPeriod)                                                        |                                                                                                                                                               |
...
| author dateTime            | [MedicationRequest.authoredOn](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.authoredOn)                                                                       | Author dateTime not referenced in QDM                                                                                                                         |
| recorder                   | [MedicationRequest.recorder](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.recorder)                                                                                                                                                                                                                                                 |                                                                                                                                                               |
{: .grid}
...
| author dateTime              |                                                                                                                                                                                                            |                                                                         |
| Negation rationale           | [MedicationAdministration.status](StructureDefinition-qicore-medicationadministration-definitions.html#MedicationAdministration.status)                       | Constrain status to "not-done". Create a MedicationAdministrationNotDone profile containing constraints: (a) Value set for negation: http://hl7.org/fhir/extension-valueset-reference.html status = not-done, (b) statusReason = use a value set created from a combination of existing eCQM rationale value set (still extensible binding), (c) timing = extension for MedicationAdministration.recorded                                          |
|                              | [MedicationAdministration.statusReason](StructureDefinition-qicore-medicationadministration-definitions.html#MedicationAdministration.statusReason)           | Use a value set created from a combination of existing eCQM rationale value set (still extensible binding)                                                                        |
...
| author dateTime               |                                                                                                                                                                                    |                                                                                                                                  |
| Negation rationale            | [MedicationDispense.status](StructureDefinition-qicore-medicationdispense-definitions.html#MedicationDispense.status)                                                              | Constrain MedicationDispense.status code to "declined". Create a MedicationDispenseNotDone profile including the following constraints: (a) Value set for negation: http://hl7.org/fhir/extension-valueset-reference.html (b) status = declined, (c) MedicationDispense.statusReason = use a value set created from a combination of existing eCQM rationale value set (still extensible binding), (d) timing = extension for MedicationDispense.recorded                                                               |
|                               | [MedicationDispense.statusReason\[x\]](StructureDefinition-qicore-medicationdispense-definitions.html#MedicationDispense.statusReason[x])                                          | The reason for ordering or not ordering the medication. Use a value set created from a combination of existing eCQM rationale value set (still extensible binding)                                                                           |
|                               | [MedicationDispense.extension.recorded](StructureDefinition-qicore-medicationnotdispensed-definitions.html#MedicationDispense.extension:recorded)                                  | Negation timing
...
| Negation rationale                     | [MedicationRequest.doNotPerform](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.doNotPerform)                                                     | Create a new Profile MedicationNotRequested containing the following constraints: (a) Value set for negation: http://hl7.org/fhir/extension-valueset-reference.html, (b) status ="completed", (c) doNotPerform is true, (d) MedicationRequest.reasonCode =  use a value set created from a combination of existing eCQM rationale value set (still extensible binding), (e) timing = MedicationRequest.authoredOn                                                                                                                                                                                         |
|                                        | [MedicationRequest.reasonCode](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.reasonCode)                                                         | The reason for ordering or not ordering the medication. use a value set created from a combination of existing eCQM rationale value set (still extensible binding)                                                                                                                                |
...
|                         | [MedicationRequest.statusReason](StructureDefinition-qicore-immunizationnotdone-definitions.html#Immunization.statusReason)                                                        | The reason for ordering or not ordering the medication                                                                                                                                   |
...
| reason                  | [MedicationRequest.reasonCode](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.reasonCode)                                                         | The reason for ordering or not ordering the medication                                                                                                                                   |
| supply                  | [MedicationRequest.dispenseRequest.quantity](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.dispenseRequest.quantity)                             | Amount to be dispensed in one fill                                                                                                                                                       |
| Negation rationale      | [MedicationRequest.doNotPerform](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.doNotPerform)                                                     | Boolean. Create a new Profile MedicationNotRequested containing the following constraints: (a) Value set for negation: http://hl7.org/fhir/extension-valueset-reference.html, (b) status ="completed", (c) doNotPerform is true, (d) MedicationRequest.reasonCode =  use a value set created from a combination of existing eCQM rationale value set (still extensible binding), (e) timing = MedicationRequest.authoredOn                                                                                                                                                                                  |
|                         | [MedicationRequest.reasonCode](StructureDefinition-qicore-medicationrequest-definitions.html#MedicationRequest.reasonCode)                                                         | The reason for ordering or not ordering the medication. use a value set created from a combination of existing eCQM rationale value set (still extensible binding)                                                                                                                                   |
...
| Author dateTime                                                   | [ServiceRequest.authoredOn](StructureDefinition-qicore-servicerequest-definitions.html#ServiceRequest.authoredOn)                           | When the request transitioned to being actionable. Also used for timing of negation rationale.                                                             |
