...
The implementation guide is based on [FHIR version 4.0.0 (R4 release)](http://hl7.org/fhir/R4/index.html) and depends on the [US Core implementation guide (STU 2)](http://hl7.org/fhir/us/core/STU2/index.html).
