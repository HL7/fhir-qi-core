...
1. Changed Claim.diagnosis.type binding and documentation for principal diagnosis ([FHIR-47295](https://jira.hl7.org/browse/FHIR-47295)) Applied ([here](StructureDefinition-qicore-claim.html)) and ([here](qdm-to-qicore.html#encounter-related-diagnoses-and-procedures))
