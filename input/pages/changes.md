...
1. Removed negation-discerning status values from non-negation profiles ([FHIR-38788](https://jira.hl7.org/browse/FHIR-38788))
1. Changed TaskNotDone profile to TaskRejected throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Changed ObservationNotDone profile to ObservationCancelled throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Changed MedicationDispenseNotDone profile to MedicationDispenseDeclined throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Fixed title for negation rationale for Immunization, Administered in QDM to QI Core Mapping([FHIR-39307](https://jira.hl7.org/browse/FHIR-39307))
1. Fixed title for negation rationale for Laboratory Text, Order in QDM to QI Core Mapping ([FHIR-39307](https://jira.hl7.org/browse/FHIR-39307))
1. Removed negation-discerning status values from non-negation profiles ([FHIR-38788](https://jira.hl7.org/browse/FHIR-38788))
1. Changed TaskNotDone profile to TaskRejected throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Changed ObservationNotDone profile to ObservationCancelled throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Changed MedicationDispenseNotDone profile to MedicationDispenseDeclined throughout ([FHIR-38850](https://jira.hl7.org/browse/FHIR-38850))
1. Fixed title for negation rationale for Immunization, Administered in QDM to QI Core Mapping([FHIR-39307](https://jira.hl7.org/browse/FHIR-39307)) 
1. Fixed title for negation rationale for Laboratory Text, Order in QDM to QI Core Mapping([FHIR-39307](https://jira.hl7.org/browse/FHIR-39307))
1. Remove ValueSet-qiqore-servicerequest-reason-rejected ([FHIR-38574](https://jira.hl7.org/browse/FHIR-38574))      
1. Remove ValueSet-qicore-observation-verification  (both valueset and codesystem) ([FHIR-38569](https://jira.hl7.org/browse/FHIR-38569))  
1. Remove Valueset-qicore-flag-category ([FHIR-38563](https://jira.hl7.org/browse/FHIR-38563))  
1. Remove Valueset-qicore-encounter-condition-role ([FHIR-38561](https://jira.hl7.org/browse/FHIR-38561))  
1. Remove Valueset-qicore-encounter-canceled-reason ([FHIR-38560](https://jira.hl7.org/browse/FHIR-38560))  
1. Remove Valueset-qicore-condition-criticality (both valueset and codesystem) ([FHIR-38558](https://jira.hl7.org/browse/FHIR-38558))  
1. Remove Valueset-qicore-condition-stage ([FHIR-38559](https://jira.hl7.org/browse/FHIR-38559))  
1. Remove Valueset-qicore-condition-certainty ([FHIR-38557](https://jira.hl7.org/browse/FHIR-38557))  
1. Remove Valueset-qicore-communication-reason-not-performed ([FHIR-38556](https://jira.hl7.org/browse/FHIR-38556)) 
