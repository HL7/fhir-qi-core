...
As an example, to generate the ModelInfo file for QICore version 7.0.2, the following arguments are used:

```
-GenerateMIs -ip=C:\Users\UserName\Documents\Src\HL7\FHIR-Spec -rp="4.0.1;US-Core/7.0.0;QI-Core/7.0.2" -mn=QICore -mv=7.0.2 -im=false -ucp=true
```
