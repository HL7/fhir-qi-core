...
#### Documenting a specific activity was not performed for a given reason.
...
#### Documenting no members of an entire value set performed for a given reason.

This can occur when the no treatment of the type included in the value set is appropriate. The approach provided allows systems to document using one profiled data instance that none of the activities in a particular value set were performed, rather than requiring documentation of multiple individual activities from the value set.
