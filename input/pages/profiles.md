...
|QI-Core (7.0.0) Profile|US Core (7.0.0) Profile|Base Resource|
|----|:----:|----:|
|**2.1.1 AdverseEvent**|
...
|&emsp; [ QICore Communication Not Done](StructureDefinition-qicore-communicationnotdone.html)| &mdash; |&emsp; [ Communication]({{site.data.fhir.path}}communication.html)|
...
|&emsp; [ QICore MedicationAdministration Not Done](StructureDefinition-qicore-medicationadministrationnotdone.html)| &mdash; |&emsp; [ MedicationAdministration]({{site.data.fhir.path}}medicationadministration.html)|
...
|&emsp; [ QICore Observation Cancelled](StructureDefinition-qicore-observationcancelled.html)| &mdash; |&emsp; [ Observation]({{site.data.fhir.path}}observation.html)|
